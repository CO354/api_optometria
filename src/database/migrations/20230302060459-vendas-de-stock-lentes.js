module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('lentesvendastock', {
      id: {
      ...
      stock_id: { // => Referece o id da tabela do aluno
        ...
        allowNull: false,
        references: {
          model: 'stock_lentes', // => Referencia o model da tabela de alunos "no caso"
  ...
  async down(queryInterface) {
    await queryInterface.dropTable('lentesvendastock');
  },
};
